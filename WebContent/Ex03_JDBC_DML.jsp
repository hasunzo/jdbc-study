...
/* 
	...
	KEY POINT
	1. Oracle DML (developter, cmd, Tool) 하면 기본 옵션이 commit or rollback 강제
	...
	java code에서 명시적으로 >> commit(), rollblack 구현해야한다
...
*/
	...
	try{
		...
		conn = DriverManager.getConnection("jdbc:oracle:thin:@192.168.0.53:1521:xe","BITUSER","1004");
		...
		String sql = "inset into dmlemp(empno, ename, dpetno)";
